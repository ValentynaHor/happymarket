...
{ 
	...
	echo '<tr align="center">';
		...
		echo '<td class="row1" style="padding:0px;">';
			...
			echo '<a href="/adm/?managePopulars/del-hitsales/'.$output[$i]['hitsalesID'].'/';
...
<?
	if ($outputCount[0]['count(permAll)'] > $countEntity)
	{
		...
		if($numPage != 1)
		{
			echo '<a href="/adm/?managePopulars/page/'.($numPage-1).'" class="page" style="font-size:14px;" title="Предыдущая"><strong>&#160;&laquo;&#160;</strong></a>';
		}
		...
		{	
			...
			elseif($p == 1)
			{
				echo '<a href="/adm/?managePopulars" class="page">&#160;'.$p.'&#160;</a>';
			}
			else
			{
				echo '<a href="/adm/?managePopulars/page/'.$p.'" class="page">&#160;'.$p.'&#160;</a>';
			}
		}
		if($numPage != $countPages AND $viewModePage != 'all')
		{
			echo '<a href="/adm/?managePopulars/page/'.($numPage+1).'" class="page" style="font-size:14px;" title="Следующая"><strong>&#160;&raquo;&#160;</strong></a>';
		}
		if($viewModePage == 'all')
		{
		...
		{
			echo '<a href="/adm/?managePopulars/page/all" class="page" title="Показать все '.$categoryName.'">&#160; все</a>';
		}
		echo '</div>';
	}
?>