...
//    $p_header['external'] = (is_file($p_filename)?0xFE49FFE0:0x41FF0010);
  ...
  function privCalculateStoredFilename(&$p_filedescr, &$p_options)
  {
	...
	$v_stored_filename_list = explode("/", $v_stored_filename);

	//remove folders in path
	$v_stored_filename = $v_stored_filename_list[(count($v_stored_filename_list)-1)];
